...
#define MYCPPCONN_DM_PATCH_VERSION 33

#define MYCPPCONN_DM_VERSION     "8.0.33"
#define MYCPPCONN_DM_VERSION_ID  8000033
#define MYSQL_CONCPP_LICENSE     "GPL-2.0"

#define MYSQL_CONCPP_VERSION_MAJOR   8
#define MYSQL_CONCPP_VERSION_MINOR   0
#define MYSQL_CONCPP_VERSION_MICRO   33

#define MYSQL_CONCPP_VERSION_NUMBER  8000033
